...
const PIECES: readonly Piece[] = [
  { icon: null, size: 46, left: '8%', top: '11%', opacity: 0.14, drift: 12, rotate: 8, durationMs: 5200, delayMs: 0, isAccent: true },
  { icon: null, size: 30, left: '78%', top: '18%', opacity: 0.1, drift: 9, rotate: 10, durationMs: 4200, delayMs: 900, isAccent: false },
  { icon: null, size: 38, left: '64%', top: '72%', opacity: 0.12, drift: 14, rotate: 7, durationMs: 6100, delayMs: 400, isAccent: true },
  { icon: null, size: 24, left: '16%', top: '63%', opacity: 0.09, drift: 8, rotate: 12, durationMs: 4700, delayMs: 1500, isAccent: false },

  { icon: 'tennisball-outline', size: 28, left: '86%', top: '44%', opacity: 0.1, drift: 10, rotate: 14, durationMs: 5600, delayMs: 300, isAccent: false },
  { icon: 'trophy-outline', size: 26, left: '5%', top: '38%', opacity: 0.09, drift: 9, rotate: 9, durationMs: 5000, delayMs: 1200, isAccent: true },
  { icon: 'medal-outline', size: 22, left: '30%', top: '8%', opacity: 0.08, drift: 7, rotate: 11, durationMs: 4400, delayMs: 700, isAccent: false },
  { icon: 'people-outline', size: 25, left: '88%', top: '82%', opacity: 0.09, drift: 11, rotate: 8, durationMs: 5800, delayMs: 1800, isAccent: false },
  { icon: 'calendar-outline', size: 21, left: '7%', top: '84%', opacity: 0.08, drift: 8, rotate: 10, durationMs: 4900, delayMs: 2100, isAccent: true },
  { icon: 'stopwatch-outline', size: 20, left: '46%', top: '90%', opacity: 0.07, drift: 7, rotate: 12, durationMs: 5400, delayMs: 600, isAccent: false },
  { icon: 'flame-outline', size: 19, left: '55%', top: '4%', opacity: 0.08, drift: 9, rotate: 13, durationMs: 4600, delayMs: 1400, isAccent: false },
];
